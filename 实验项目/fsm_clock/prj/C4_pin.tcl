...
#数码管片选
set_location_assignment PIN_A4 -to seg_sel_n[5]
set_location_assignment PIN_B4 -to seg_sel_n[4]
set_location_assignment PIN_A3 -to seg_sel_n[3]
set_location_assignment PIN_B3 -to seg_sel_n[2]
set_location_assignment PIN_A2 -to seg_sel_n[1]
set_location_assignment PIN_B1 -to seg_sel_n[0]
