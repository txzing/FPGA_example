...
# Set Output Delay
#**************************************************************
set_output_delay -clock { clk } -rise -add_delay 5 [get_ports {vga_r[*]}]
set_output_delay -clock { clk } -rise -add_delay 5 [get_ports {vga_g[*]}]
set_output_delay -clock { clk } -rise -add_delay 5 [get_ports {vga_b[*]}]
set_output_delay -clock { clk } -rise -add_delay 10 [get_ports {vga_clk}]
...
set_false_path -from [get_clocks {clk}] -through [get_nets {u_sdram_ctrl|u_rw_ctrl|wr_frame_end}] -to [get_clocks {cmos_pclk}]
set_false_path -from [get_clocks {clk}] -to [get_clocks {cmos_pclk}]
set_false_path -from [get_clocks {cmos_pclk}] -to [get_clocks {clk}]
